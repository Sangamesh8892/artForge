...
const Testimonials = () => {
  return (
    ...
    viewport={{once:true}}>
        ...
        <p className='text-gray-600 mb-8'>Hers Whats our Cutomers are Saying</p>
        <div className='flex flex-wrap gap-6'>
            {testimonialsData.map((item,index)=>(
                <div key={index} className='bg-white/20 p-12 rounded-lg shadow-md order w-80 m-auto cursor-pointer hover:scale-[1.02] transition-all duration-300'>
